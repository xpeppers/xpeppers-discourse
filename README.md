...
6. Update cloudformation: ```aws cloudformation update-stack --profile <AWS-PROFILE> --stack-name <STACK_NAME> --template-body file://cloudformation/ec2.yml --parameters file://cloudformation/ec2-parameters.json --region <REGION> --capabilities CAPABILITY_IAM```
